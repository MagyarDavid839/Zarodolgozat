						...
						<div class="card rounded-0" align="center";>
							...
							<div class="card-body">
								<div class="lh-1">
									...
									<div><small class="card-description text-success h6 mb-0"><?php echo $item["price"]; ?>Ft</small></div>
									<div class="d-grid">
									<div class="input-group input-sm">
										<span class="input-group-text rounded-0">Mennyiség</span>
										<input type="number" class="form-control rounded-0 text-center" id="quantity" name="quantity" value="1" required="required">
									</div>
									<input type="submit" name="add" style="margin-top:5px;" class="btn btn-primary btn-sm rounded-0" value="Kosárba">
									</div>
								</div>
							</div>
